...
def test_should_enforce_first_or_last(settings):
    settings.RELAY_CONNECTION_ENFORCE_FIRST_OR_LAST = True
...
def test_should_error_if_first_is_greater_than_max(settings):
    settings.RELAY_CONNECTION_MAX_LIMIT = 100
...
def test_should_error_if_last_is_greater_than_max(settings):
    settings.RELAY_CONNECTION_MAX_LIMIT = 100
